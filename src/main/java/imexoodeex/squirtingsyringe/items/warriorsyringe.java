...
public class warriorsyringe extends Item {
    ...
    public ActionResult useOnEntity(ItemStack stack, PlayerEntity playerEntity, LivingEntity entity, Hand hand) {
        ...
        entity.addStatusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE, (1200), (1), true, false));
        entity.addStatusEffect(new StatusEffectInstance(StatusEffects.STRENGTH, (1200), (0), true, false));
        entity.addStatusEffect(new StatusEffectInstance(StatusEffects.HEALTH_BOOST, (1200), (0), true, false));
